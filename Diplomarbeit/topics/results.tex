...
In the scope of this diploma thesis, a concept for a modular smart home system
was developed into a working prototype featuring working modules and a complete
example of a complete communication chain, meaning a measured value can be 
requested from a Node, sent to the bridge and then displayed on a web interface.
The following chapter will outline the results of the project. It will
describe future plans, the results of the range tests conducted with the Nodes
and price calculations for the components used in the project.
...
the stronger the signal. The RSSI value is measured in dBm.
    ...
    The indoor test was conducted in a three-storey apartment building.
    ...
    \begin{table}[H]
        ...
        \begin{minipage}{0.40\textwidth} % Adjust width as needed
            ...
            \begin{tabular}{|p{2cm}|p{1.6cm}|p{1.6cm}|}
                ...
                12  & -89 & 21 \\ \hline
            \end{tabular}
            \label{tab:node_range_test_indoor}
        \end{minipage}%
        \hfill % Adds horizontal space between the table and figure
        \begin{minipage}{0.55\textwidth} % Adjust width as needed
            \centering
