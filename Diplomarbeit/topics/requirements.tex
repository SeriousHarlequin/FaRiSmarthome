...
to implement the project.
    ...
    \section{Altium Designer® 24}

    Altium is a PCB design software that is used professionally in the
    industry. It offers a wide range of features such as simulating circuts, 
    ...
    Fusion 360 is a all in one CAD, CAM, CAE, and PCB platform.\cite{noauthor_autodesk_nodate} It is used 
