...
to implement the project.
    ...
    \end{wrapfigure}
    The Arduino framework \cite{what_is_Arduino} is an open source platform that
    ...
    considered and used for the various communication channels.
        ...
        The following protocols are considered:
            ...
            works on a publishing/subscribe model, which makes it easy
            ...
            \end{wrapfigure}
            ESP-NOW \cite{what_is_espnow} is a wireless communication protocol capable of
    ...
    \section{Altium Designer\textregistered 24}
    \setAuthor{Richard Krammer}
    Altium is a PCB design software that is used professionally in the
    industry. It offers a wide range of features such as simulating circuits, 
    drawing schematics, and laying out PCBs. \cite{noauthor_pcb-design_nodate} All of the hardware is designed
    using Altium Designer. The software is used to create the schematic and
    the PCB layout.

    \section{Autodesk Fusion 360\textregistered}

    Fusion 360 is an all-in-one CAD, CAM, CAE, and PCB platform. \cite{noauthor_autodesk_nodate} It is used 
    in this project to design the enclosure for the PCBs.