\section{Case} \setAuthor{Richard Krammer}
    ...
    \subsection{Battery}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.55\textwidth]{assets/case/Battery-Top.JPG}
            \caption{Top view}
        \end{figure}

        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.55\textwidth]{assets/case/Battery-Side.JPG}
            \caption{Side view}
        \end{figure}
    ...
    \subsection{Switch}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.6\textwidth, angle = 0]{assets/case/Switch-Open1.JPG}
                \caption{Case open top view}
            \end{figure}
    
            \begin{figure}[htbp]
                \centering
                \includegraphics[width=0.55\textwidth, angle = -90]{assets/case/Switch-Closed2.JPG}
