...
\setAuthor{Richard Krammer}
    ...
    \subsubsection{Module Detection}
        ...
        The basic node regonizes the attached module by measuring the voltage on pin 3.
    ...
    \subsubsection{PCB - V2.2}
        ...
        The PCB has a size of 75x30mm. The compenents used were mainly SMD components, 
