...
\setAuthor{Richard Krammer}
    ...
    \subsubsection{Microcontroller}
        ...
        to see which one would be the better fit for the basic node. 
    ...
    \subsubsection{Temperature Sensor}
        ...
        This sensor was used instead of the DHT11, for being smaller.
    ...
    \subsubsection{Module Detection}
        ...
        When a module is attached, a voltage divider is created. The voltage on pin 9 is 
        determined by the second resistor on the module. The microcontroller reads the
