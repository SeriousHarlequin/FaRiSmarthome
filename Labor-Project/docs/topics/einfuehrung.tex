...
abzufragen und anzupassen.
    ...
    \\~\\
    Die Kommunikation des Systems kann wie folgt visualisiert werden: 
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=1\textwidth]{Networking.png}
        \caption{Das Smarthome}
        \label{fig:smarthome}
    \end{figure}

    Das Control-Panel wird als Node in diesem Netzwerk fungieren.
